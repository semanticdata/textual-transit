...
from .metro_api import get_blue_line_map, get_green_line_map
...
class CombinedMapTab(Static):
    ...
    def render_map_line(
        ...
        green_label_padded = green_label_fmt + " " * (
            label_pad - len(green_plain_label)
        )
    ...
    def refresh_map(self):
        ...
        green_line_stations = [
            ...
            {
                "name": "West Bank",
                "latitude": 44.97358033375315,
                "longitude": -93.24327694824411,
            },
            {
                "name": "East Bank",
                "latitude": 44.97239212668269,
                "longitude": -93.2358258120996,
            },
            {
                "name": "Stadium Village",
                "latitude": 44.97239212668269,
                "longitude": -93.22497335430691,
            },
            {
                "name": "Prospect Park",
            ...
            {
                "name": "Lexington Pkwy",
                "latitude": 44.95561534413747,
                "longitude": -93.1465576641505,
            },
            {
                "name": "Victoria St",
                "latitude": 44.95553260886939,
                "longitude": -93.13297734221652,
            },
            {
                "name": "Dale St",
                "latitude": 44.95548613234419,
                "longitude": -93.12369004564545,
            },
            {
                "name": "Western Ave",
                "latitude": 44.9554408663451,
                "longitude": -93.11734185895557,
            },
            {
                "name": "Robert St",
                "latitude": 44.94893285666344,
                "longitude": -93.09923749370954,
            },
            {
                "name": "10th St",
                "latitude": 44.94866632452591,
                "longitude": -93.09466742023244,
            },
            {
                "name": "Central",
                "latitude": 44.94850503452919,
                "longitude": -93.09214576888003,
            },
            {
                "name": "Union Depot",
            ...
            for v in vehicles:
                ...
                if closest_idx is not None:
                    ...
                    if direction == "stationary":
                        ...
                        marker = (
                            "▲" if v.get("bearing", 90) > 90 else "▼"
                        )  # crude east/west
                    else:
                        marker = (
                            "▲" if v.get("bearing", 0) < 180 else "▼"
                        )  # crude north/south
                    train_indices[closest_idx] = marker
            return train_indices

        blue_trains = get_train_indices(blue_stations, blue_coords, blue_vehicles)
        green_trains = get_train_indices(
            green_stations, green_coords, green_vehicles, is_green=True
        )
        # Compose map lines
        now = datetime.now()
